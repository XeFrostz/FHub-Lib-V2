...
-- Main Library
function FrxserLibrary:CreateWindow(options)
    options = options or {}
...
-- Static methods
function FrxserLibrary:GetThemes()
    local list = {}
    for n, _ in pairs(Themes) do table.insert(list, n) end
    return list
end

function FrxserLibrary:AddTheme(name, data)
    Themes[name] = data
end

function FrxserLibrary:IsMobile()
    return UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled
end

return FrxserLibrary
