...
local FrxserLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/XeFrostz/FHub-Lib-V2/refs/heads/main/lib.lua"))()

-- Create main window
local Window = FrxserLib:CreateWindow({
